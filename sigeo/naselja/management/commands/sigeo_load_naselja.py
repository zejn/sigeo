...
naselje_re = re.compile('(?P<ob_id>\d{3})(?P<ob_ime>.{30})(?P<ob_uime>.{50})(?P<ob_dj>.{50})(?P<na_mid>\d{8})(?P<na_id>\d{3})(?P<na_ime>.{30})(?P<na_uime>.{50})(?P<na_dj>.{50})(?P<d_od>\d\d\.\d\d\.\d{4} \d\d:\d\d:\d\d)(?P<povrsina>[\d.]{15})')
